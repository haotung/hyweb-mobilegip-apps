...
function create_entity() {
  ...
  $token1 = new Google_Service_Datastore_Property();
  $token1->setStringValue('token_abcdefg');
  $token2 = new Google_Service_Datastore_Property();
  $token2->setStringValue('token_alawofijawefo');
  $tokens[] = $token1;
  $tokens[] = $token2;
  $list_prop = new Google_Service_Datastore_Property();
  $list_prop->setListValue($tokens);
  $property_map = [];
  $property_map["testfield"] = $string_prop;
  $property_map['tokens'] = $list_prop;
